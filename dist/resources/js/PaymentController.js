    ...
    function PaymentController(configuration) {
        ...
        this.display = ({storeId}) => {
            ...
            Promise.all([
                ...
                paymentMethods ? [] : api.get(configuration.getPaymentMethodsUrl.replace(encodeURIComponent('{merchantId}'), countryConfiguration[0].merchantId), null, SequraFE.customHeader),
        ...
        const handleCountryChange = (value) => {
            ...
            api.get(configuration.getPaymentMethodsUrl.replace(encodeURIComponent('{merchantId}'), value), null, SequraFE.customHeader)
                .then((methods) => {
